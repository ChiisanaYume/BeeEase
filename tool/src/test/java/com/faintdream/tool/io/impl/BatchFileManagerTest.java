...
public class BatchFileManagerTest {
    ...
    public void add1Test(){
        File file1 = new File("addTest1-01.txt").getAbsoluteFile();
        File file2 = new File("addTest1-02.txt").getAbsoluteFile();
        File file3 = new File("addTest1-03.txt").getAbsoluteFile();
    ...
    @Test
    public void add1Test2() throws IOException {
        File file1 = new File("addTest2-01.txt").getAbsoluteFile();
        File file2 = new File("addTest2-02.txt").getAbsoluteFile();
        File file3 = new File("addTest2-03.txt").getAbsoluteFile();
        ...
        for(File key:fileMap.keySet()){
            String tag = manager.getFileMap().get(key);
